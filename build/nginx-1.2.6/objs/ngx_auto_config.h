#define NGX_CONFIGURE " --prefix=/usr/local/nginx//nginx --add-module=../ngx_devel_kit-0.2.17 --add-module=../echo-nginx-module-0.41 --add-module=../xss-nginx-module-0.03rc9 --add-module=../ngx_coolkit-0.2rc1 --add-module=../set-misc-nginx-module-0.22rc8 --add-module=../form-input-nginx-module-0.07rc5 --add-module=../encrypted-session-nginx-module-0.02 --add-module=../srcache-nginx-module-0.17 --add-module=../ngx_lua-0.7.13 --add-module=../headers-more-nginx-module-0.19 --add-module=../array-var-nginx-module-0.03rc1 --add-module=../memc-nginx-module-0.13rc3 --add-module=../redis2-nginx-module-0.09 --add-module=../redis-nginx-module-0.3.6 --add-module=../auth-request-nginx-module-0.2 --add-module=../rds-json-nginx-module-0.12rc10 --add-module=../rds-csv-nginx-module-0.05rc2 --user=www-data --group=www-data --sbin-path=/usr/local/sbin --with-http_perl_module --add-module=/tmp/nginx-catap/tmp/www-nginx-bundle/bundle/ngx_http_auth_request_module --with-http_ssl_module"
...
#ifndef NGX_PREFIX
#define NGX_PREFIX  "/usr/local/nginx//nginx/"
#endif
